...
<Meta title="Documentation/Contributing Baklava Icons/Commit Rules" />

# Baklava Commit Rules

While developing Baklava Icons we use [conventional commit messages](https://www.conventionalcommits.org/en/v1.0.0/). When you commit a change to your local branch, a couple of checks will be done including commit message. If you make a mistake while writing your commit message, you'll see an error message like below and your commit will be cancelled:
...
## Specific rules for Baklava Icons
